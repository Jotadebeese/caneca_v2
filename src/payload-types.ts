...
/**
 * Images uploaded by users for model training.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Submission {
  id: number;
  /**
   * The image submitted by the user.
   */
  image: number | Media;
  modelPrediction?: (number | null) | Label;
  userCorrectedLabel: number | Label;
